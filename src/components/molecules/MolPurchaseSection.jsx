...
import AtmGoogleForm from '../atoms/AtmGoogleForm'
import { useTranslation } from '../../hooks/useTranslation'

const MolPurchaseSection = () => {
  const { t } = useTranslation()
  // Change this to false to show the Google Form instead of the Stripe button
  const isAvailable = false

  return (
    <div className="max-w-4xl mx-auto py-10" id="buy">
      {isAvailable ? (
